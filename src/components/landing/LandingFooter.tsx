...
export default function LandingFooter() {
  return (
    <footer className="bg-[#001a10] text-white py-16 px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Global low-carbon action registry, providing transparency and permanent impact tracking.
            </p>
          ...
          <div className="flex flex-col gap-4">
            <h4 className="text-[#b0f0d6] text-xs font-bold uppercase tracking-widest">
              Registry
            </h4>
            <div className="flex flex-col gap-3 text-sm font-medium text-[#f1f5f9] opacity-80">
              <Link href="/signin" className="hover:text-[#a8f928] transition-colors">Register Action</Link>
              <Link href="/signin" className="hover:text-[#a8f928] transition-colors">Verify Certificate</Link>
              <a href="#how-it-works" className="hover:text-[#a8f928] transition-colors">How It Works</a>
              <a href="#scope" className="hover:text-[#a8f928] transition-colors">Scope of Actions</a>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4">
              <Link href="/signin" className="w-8 h-8 rounded-lg bg-[#064e3b] flex items-center justify-center hover:bg-[#a8f928] hover:text-[#112000] transition-all">
