                ...
                <div className="text-center space-y-4">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6 border-b border-slate-200 pb-8">
                        <div className="space-y-1 text-center md:text-left">
                            <h1 className="text-2xl md:text-3xl font-black text-slate-800 tracking-tight text-center md:text-left">
                                {profile && !isProfileIncomplete ? "User Profile" : "Create Your Profile"}
                            </h1>
                            <p className="text-sm md:text-base text-slate-500 font-medium text-center md:text-left">
                                {profile && !isProfileIncomplete
                        ...
                        {profile && !isEditing && (
                            <Button
                                ...
                                className="bg-[#003527] hover:bg-[#064e3b] !px-8 !py-2 !rounded-lg shadow-lg transform hover:-translate-y-1 transition-all"
                            >
                        ...
                        {isEditing ? (
                            <div className="space-y-10">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    {formData.institutionType && (
                                        <div className="md:col-span-2 p-8 bg-slate-50/50 rounded-lg border-2 border-slate-200">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                {formData.institutionType === 'School' ? (
                                                    ...
                                                    <div className="md:col-span-2">
                                                        <Input
                                                            ...
                                                            className="!py-2 !rounded-lg !border-slate-300 focus:!border-blue-500"
                                                        />
                                                    </div>
                                                )}
                                                ...
                                                <div className="md:col-span-2 space-y-6">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                        ...
                                                        <Input label="City" value={formData.city} placeholder="Auto-filled" disabled className="!py-2 !rounded-lg bg-slate-100/80 border-slate-200" />
                                                        <div className="space-y-2">
                                                            <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">State</label>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                        <Input label="Primary Contact Person" value={formData.contactPerson} onChange={(e) => handleChange("contactPerson", e.target.value)} className="!py-2 !rounded-lg !border-slate-300 focus:!border-blue-500" />
                                                        <Input label="Email Address" value={formData.email} disabled className="!py-2 !rounded-lg bg-slate-100 !border-slate-300 opacity-80" />
                                                        <Input label="Phone Number" value={formData.phone} onChange={(e) => handleChange("phone", e.target.value)} className="!py-2 !rounded-lg !border-slate-300 focus:!border-blue-500" />
                                                    </div>
                                ...
                                <div className="flex flex-col-reverse sm:flex-row gap-4 pt-6 border-t border-slate-100">
                                    <Button
                                        ...
                                        className="w-full sm:w-auto px-8 py-4 uppercase tracking-widest font-black text-[10px]"
                                    >
                                        Cancel
                                    </Button>
                                    <Button
                                        ...
                                        disabled={saving}
                                        className="flex-1 px-8 py-4 bg-[#003527] text-white uppercase tracking-widest font-black text-[10px] shadow-xl shadow-emerald-900/20 active:scale-95 transition-all"
                                    >
                            ...
                            <div className="space-y-12 animate-in fade-in duration-500">
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Entity Type</p>
                                        <p className="text-xs font-black text-slate-800">{formData.institutionType}</p>
                                    </div>
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Name</p>
                                        <p className="text-xs font-black text-slate-800">{formData.displayName}</p>
                                    </div>
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Contact Person</p>
                                        <p className="text-xs font-black text-slate-800">{formData.contactPerson}</p>
                                    </div>
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Phone Number</p>
                                        <p className="text-xs font-black text-slate-800">{formData.phone}</p>
                                    </div>
                                    <div className="space-y-1 text-wrap break-words">
                                        ...
                                        <p className="text-xs font-black text-slate-800 truncate" title={formData.email}>{formData.email}</p>
                                    </div>
                                    ...
                                    <div className="md:col-span-2 lg:col-span-3 space-y-1 pt-6 border-t border-slate-50">
                                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Full Address</p>
                                        <p className="text-xs font-black text-slate-800 leading-tight max-w-4xl">
                                            {formData.address}
                                        </p>
                                    </div>
                                </div>
                                ...
                                {formData.socialHandles.some(h => h) && (
                                    <div className="pt-10 border-t border-slate-100">
                                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4">Web & Social Presence</p>
                                        <div className="flex flex-wrap gap-4">
                                            {formData.socialHandles.map((handle, idx) => handle && (
                                                <div key={idx} className="bg-slate-50 px-6 py-3 rounded-lg text-sm font-bold text-slate-600 border-2 border-slate-200">
                                                    {handle}
                                                </div>
                                            ))}
                                        </div>
